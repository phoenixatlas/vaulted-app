...
# ============================================================================
# KYC / IDENTITY — extracted to routers/kyc.py
# ============================================================================
# The three /kyc/* endpoints (status, debug, session) and the two Stripe
# webhook handlers (_apply_identity_verified, _apply_identity_requires_input)
# live in /app/backend/routers/kyc.py. The webhook handlers are re-imported
# at the bottom of this file so the central Stripe webhook dispatcher
# (search for 'identity.verification_session.verified') can call them
...
# Re-import a couple of helpers used by remit endpoints that still live here.
# When we extract the remit router these become internal to that router.
from routers.stripe_router import _success_cancel_urls  # noqa: E402
...
from routers.kyc import (
    ...
    _apply_identity_requires_input,
)
